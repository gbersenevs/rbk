          ...
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6">
              ...
              {home.hero.sublines.map((line, i) => (
                <span key={i} className="block text-neutral-500 dark:text-neutral-400">
                  {line}
                </span>
              ))}
            </h1>
      ...
      <section className="py-16 md:py-20 bg-neutral-50 dark:bg-neutral-900 border-y border-neutral-200 dark:border-neutral-800">
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="font-medium text-neutral-900 dark:text-white">{home.approach.goal}</p>
          </div>
        </Container>
      </section>
            ...
            {home.principles.items.map((principle, index) => (
              <div key={principle.title} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8">
                  ...
                  <p className="text-sm text-neutral-500 dark:text-neutral-500">{principle.detail}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <Container>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            {portfolioItems.map((item) => (
              <article
                key={item.title}
                className="space-y-3 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 p-6"
              >
                <div className="relative overflow-hidden rounded-xl bg-neutral-100 dark:bg-neutral-900/50">
                  <div className="h-40 w-full relative">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "linear-gradient(135deg, rgba(17,24,39,0.2) 25%, transparent 25%), linear-gradient(225deg, rgba(17,24,39,0.2) 25%, transparent 25%)",
      ...
      <section className="py-16 md:py-24 bg-neutral-100 dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-800">
        <Container>
          <div className="max-w-2xl">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mb-8">{home.cta.description}</p>
            <Button href={home.cta.buttonHref} variant="secondary" size="lg">
